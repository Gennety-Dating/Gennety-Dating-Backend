...
const SCRIPT: Record<DemoBeat, BeatCopy> = {
  ...
  chat_open: {
    ru:
      ...
      "В продакшене он открывается за час до встречи и закрывается через " +
      ...
      "Представьте, что до встречи час. Нажмите «Войти в чат» и напишите " +
    ...
    uk:
      ...
      "У продакшені він відкривається за годину до зустрічі й закривається " +
      ...
      "Уявіть, що до зустрічі година. Натисніть «Увійти в чат» і напишіть " +
    ...
    en:
      ...
      "In production it opens an hour before you meet and closes two hours " +
      ...
      "Imagine you're an hour out. Tap \"Enter chat\" and write something — " +
