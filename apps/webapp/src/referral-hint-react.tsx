 ...
 *
 * There is no `tight` variant any more: it existed to pair the chip with the
 * Premium row above it as "offer + footnote", and the referral program no
 * longer rides on any Premium pitch (2026-09-22) — the chip always stands on
 * its own at its normal spacing.
 */
