...
| POST | `/v1/venue-change/pay-decline` | His single, final "not this time" from the Mini App fork (twin of the wish-card callback). Stamps `venueChangePayDeclinedAt` + soft pay-self DM to her. Telegram `initData` HMAC auth. |
