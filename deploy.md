...
**Девять вещей, которые стоит знать до редеплоя:**
...
Preflight по этому изменению: typecheck чист, lint чист, **494 теста вебаппа**
(45 файлов, 54 в `mascot-welcome.test.ts`), `vite build` чист. Девять несущих
гвардов подтверждены красными по отдельности. Пять от 2026-08-23/26: снятая
...
вернуть на сцену». И четыре от правки потока: снятый фейд роняет 3 теста,
линейная рампа вместо сглаженной — 2, рампа, зашедшая внутрь полосы viewBox —
2, возврат пола лупа на 2000 — тест «показывает минимум четыре анкеты».
