...
**PENDING — экран пола переходит на фотографии, кнопки выше (PRODUCT_SPEC §1.3,
...
- **Маска низа поднята с 58% на 76%** и обязана оставаться ниже подбородка — это
  теперь отдельный тест против `GENDER_ART_CHIN_PCT`. Скрипт подготовки лежит вне
  репозитория, так что ничто другое от рассинхрона арта и маски не страхует.
...
**PENDING — экран имени перестаёт схлопываться в верхнюю треть при открытии
