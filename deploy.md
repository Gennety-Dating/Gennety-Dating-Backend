...
**Deployed 2026-08-23 (was PENDING) — экран пола переходит на фотографии, кнопки выше (PRODUCT_SPEC §1.3,
DECISIONS.md).** **Нет изменения схемы Prisma, нет новых env, нет флагов и НЕТ
...
- **Растворение теперь с трёх сторон, а не только снизу** (низ с 70%, бока по
  18%), и обе кривые сглажены вместо линейных. Верх намеренно не трогается.
- **Плюс сами ассеты растушёвывают свои кадровые границы** (2026-08-23). Маска
  кнопки привязана к краю кнопки, а фигуры до него не достают: контент парня
  занимает x 61..558 из 540, девушки — 60..408. Прямые вертикали (рамка
  исходного кадра по плечу и руке, отсекатель камеры по волосам) лежат на
  11-24% ширины, где маска держит ещё >77% непрозрачности, и она их не касалась.
  Это же объясняет, почему у парня справа переход читался нормально, а слева
  нет: один край обрезан кнопкой, другой нет. **Ассеты перегенерированы** —
  без них правка бессмысленна.
