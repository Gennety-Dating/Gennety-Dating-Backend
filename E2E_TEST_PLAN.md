...
| Запасной (B) | `@gennetysupport` | `5986970093` | синтетический `dating@gennety.com` | **Email-шаг пропущен** (в `DEV_OTP_BYPASS_TELEGRAM_IDS`); всё остальное (Persona, Rekognition, фото) — полноценно |
