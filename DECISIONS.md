...
(hairColor / hairLength / build / style / tattoos) на **одну ось из 6 целостных
...
- **Вторичные теги обязаны быть декоррелированы с архетипом.** Ровно один
  тату-кадр в каждом архетипе (6 из 18), три цвета волос внутри каждого
...
- **Яркость станет крупнейшим шагом в монтаже.** Солнечная съёмка против почти
  ...
  перехода мир→титры.
- **Открытый вопрос, который я НЕ решил за фаундера:** идут ли чистые кадры до
  Telegram-карточки или после неё. Первое оставляет последним впечатлением
  продукт, второе — людей.
