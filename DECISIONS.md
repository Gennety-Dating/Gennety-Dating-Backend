...
**Deliberately not done / открыто:** поведение в демо-режиме (выдавать ли
визитёру Premium, чтобы безлимит был виден инвестору, или оставить ему обычный
платный гейт на мок-рельсе) — вопрос задан, ответа пока нет. Реализация,
