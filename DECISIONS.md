...
- **Побочно улучшилась изоляция, и её надо сохранить.** Рыжие переставлены на
  fp3 и fa3, так что теперь **все три общие локации совпадают и по цвету волос**
  (fp3/fa3 рыжие, fs3/fc3 брюнетки, fc1/fa2 блонд) — внутри пары различается
  ровно архетип. У 4/4/4 не совпадала ни одна.
- **Внутриархетипные перекосы гасят друг друга:** спортивная кренится в
  брюнеток, городская в блонд, полированная и творческая идеально
  сбалансированы. Ломать эту компенсацию нельзя — иначе цвет начнёт
