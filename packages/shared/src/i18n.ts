...
const translations = {
  en: {
    ...
    peerWaitNoOverlap: "Working out a time with {name}",
    peerWaitNoOverlapLate: "Still working out a time with {name}",
  ...
  ru: {
    ...
    peerWaitNoOverlap: "Согласовываем время с {name}",
    peerWaitNoOverlapLate: "Всё ещё согласовываем время с {name}",
  ...
  uk: {
    ...
    peerWaitNoOverlap: "Узгоджуємо час із {name}",
    peerWaitNoOverlapLate: "Досі узгоджуємо час із {name}",
...
const deTranslations: TranslationTable = {
  ...
  peerWaitNoOverlap: "Wir stimmen die Zeit mit {name} ab",
  peerWaitNoOverlapLate: "Wir stimmen weiter die Zeit mit {name} ab",
...
const plTranslations: TranslationTable = {
  ...
  peerWaitNoOverlap: "Uzgadniamy termin z {name}",
  peerWaitNoOverlapLate: "Wciąż uzgadniamy termin z {name}",
