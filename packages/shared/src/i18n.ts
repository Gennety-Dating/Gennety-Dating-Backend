...
const translations = {
  en: {
    ...
    peerWaitSaving: "📋 Saving your choice…",
    peerWaitHandoff: "💫 Letting them know…",
    peerWaitLoop1: "⏳ Waiting on {name}…",
    peerWaitLoop2: "⏳ No answer from {name} yet. I'll tell you the moment there is",
    peerWaitLoop3: "⏳ Still holding your spot — waiting on {name}…",
    peerWaitLoopAnon: "⏳ Waiting on your match…",
  ...
  ru: {
    ...
    peerWaitSaving: "📋 Сохраняю твой выбор…",
    peerWaitHandoff: "💫 Передаю второй стороне…",
    peerWaitLoop1: "⏳ Ждём ответа от {name}…",
    peerWaitLoop2: "⏳ Пока тишина со стороны {name}. Дам знать сразу",
    peerWaitLoop3: "⏳ Место за вами — ждём {name}…",
    peerWaitLoopAnon: "⏳ Ждём вторую сторону…",
  ...
  uk: {
    ...
    peerWaitSaving: "📋 Зберігаю твій вибір…",
    peerWaitHandoff: "💫 Передаю іншій стороні…",
    peerWaitLoop1: "⏳ Чекаємо на відповідь від {name}…",
    peerWaitLoop2: "⏳ Поки тиша з боку {name}. Скажу одразу",
    peerWaitLoop3: "⏳ Місце за вами — чекаємо на {name}…",
    peerWaitLoopAnon: "⏳ Чекаємо на іншу сторону…",
...
const deTranslations: TranslationTable = {
  ...
  peerWaitSaving: "📋 Speichere deine Auswahl…",
  peerWaitHandoff: "💫 Ich sage ihnen Bescheid…",
  peerWaitLoop1: "⏳ Wir warten auf {name}…",
  peerWaitLoop2: "⏳ Von {name} noch keine Antwort. Ich sage sofort Bescheid",
  peerWaitLoop3: "⏳ Euer Platz bleibt frei - wir warten auf {name}…",
  peerWaitLoopAnon: "⏳ Wir warten auf die andere Seite…",
...
const plTranslations: TranslationTable = {
  ...
  peerWaitSaving: "📋 Zapisuję twój wybór…",
  peerWaitHandoff: "💫 Daję im znać…",
  peerWaitLoop1: "⏳ Czekamy na {name}…",
  peerWaitLoop2: "⏳ Od {name} jeszcze nie ma odpowiedzi. Dam znać od razu",
  peerWaitLoop3: "⏳ Trzymamy dla was miejsce - czekamy na {name}…",
  peerWaitLoopAnon: "⏳ Czekamy na drugą stronę…",
