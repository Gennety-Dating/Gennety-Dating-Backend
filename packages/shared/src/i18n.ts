...
const translations = {
  en: {
    ...
    peerWaitT5Deadline: "Waiting on {name} — time's short",
    peerWaitAnon: "Waiting on your match",
    peerWaitNoOverlap: "No shared time yet",
    peerWaitNoOverlapLate: "Still no shared time — time's short",
  ...
  ru: {
    ...
    peerWaitT5Deadline: "Ждём {name} — время на исходе",
    peerWaitAnon: "Ждём вторую сторону",
    peerWaitNoOverlap: "Пока нет общего времени",
    peerWaitNoOverlapLate: "Общего времени нет — время на исходе",
