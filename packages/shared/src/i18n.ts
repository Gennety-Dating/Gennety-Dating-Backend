...
const translations = {
  en: {
    ...
    peerWaitNoOverlap: "Your times with {name} didn't overlap",
    peerWaitNoOverlapLate: "Still no overlap with {name}",
  ...
  ru: {
    ...
    peerWaitNoOverlap: "Ваше время с {name} не совпало",
    peerWaitNoOverlapLate: "Ваше время с {name} всё ещё не совпадает",
  ...
  uk: {
    ...
    peerWaitNoOverlap: "Ваш час із {name} не збігся",
    peerWaitNoOverlapLate: "Ваш час із {name} досі не збігається",
...
const deTranslations: TranslationTable = {
  ...
  peerWaitNoOverlap: "Eure Zeiten mit {name} passen nicht",
  peerWaitNoOverlapLate: "Eure Zeiten mit {name} passen weiterhin nicht",
...
const plTranslations: TranslationTable = {
  ...
  peerWaitNoOverlap: "Wasz czas z {name} się nie pokrył",
  peerWaitNoOverlapLate: "Wasz czas z {name} wciąż się nie pokrywa",
