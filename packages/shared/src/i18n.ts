...
const translations = {
  en: {
    ...
    pitchDeadlineBtnHm: "⏳ {h}h {m}m left to reply",
    pitchDeadlineBtnMin: "⏳ {m}m left to reply",
  ...
  ru: {
    ...
    pitchDeadlineBtnHm: "⏳ Осталось {h}ч {m}м на ответ",
    pitchDeadlineBtnMin: "⏳ Осталось {m}м на ответ",
  ...
  uk: {
    ...
    pitchDeadlineBtnHm: "⏳ Залишилось {h}год {m}хв на відповідь",
    pitchDeadlineBtnMin: "⏳ Залишилось {m}хв на відповідь",
...
const deTranslations: TranslationTable = {
  ...
  pitchDeadlineBtnHm: "⏳ Noch {h}h {m}m zum Antworten",
  pitchDeadlineBtnMin: "⏳ Noch {m}m zum Antworten",
...
const plTranslations: TranslationTable = {
  ...
  pitchDeadlineBtnHm: "⏳ Zostało {h}h {m}m na odpowiedź",
  pitchDeadlineBtnMin: "⏳ Zostało {m}m na odpowiedź",
