...
const translations = {
  en: {
    ...
    // looking at the photos rather than as silence.
    ...
    peerWaitT1Sent: "Sent to {name}",
    peerWaitT2Waiting: "Waiting on {name}",
    peerWaitT3Quiet: "No word from {name} yet",
    peerWaitT4Nudged: "Nudged {name}",
    peerWaitT5Deadline: "Waiting on {name} — time's running short",
    peerWaitAnon: "Waiting on your match",
    peerWaitNoOverlap: "No shared time yet",
    peerWaitNoOverlapLate: "Still no shared time — time's running short",
  ...
  ru: {
    ...
    peerWaitT1Sent: "Ушло к {name}",
    peerWaitT2Waiting: "Ждём {name}",
    peerWaitT3Quiet: "От {name} пока тихо",
    peerWaitT4Nudged: "Напомнил {name}",
    peerWaitT5Deadline: "Ждём {name} — время поджимает",
    peerWaitAnon: "Ждём вторую сторону",
    peerWaitNoOverlap: "Пока нет общего времени",
    peerWaitNoOverlapLate: "Общего времени нет — время поджимает",
  ...
  uk: {
    ...
    peerWaitT1Sent: "Пішло до {name}",
    peerWaitT2Waiting: "Чекаємо на {name}",
    peerWaitT3Quiet: "Від {name} поки тиша",
    peerWaitT4Nudged: "Нагадав {name}",
    peerWaitT5Deadline: "Чекаємо на {name} — час спливає",
    peerWaitAnon: "Чекаємо на іншу сторону",
    peerWaitNoOverlap: "Поки немає спільного часу",
    peerWaitNoOverlapLate: "Спільного часу немає — час спливає",
...
const deTranslations: TranslationTable = {
  ...
  peerWaitT1Sent: "An {name} raus",
  peerWaitT2Waiting: "Warten auf {name}",
  peerWaitT3Quiet: "Von {name} noch nichts",
  peerWaitT4Nudged: "{name} erinnert",
  peerWaitT5Deadline: "Warten auf {name}, Zeit wird knapp",
  peerWaitAnon: "Warten auf die andere Seite",
  peerWaitNoOverlap: "Noch keine gemeinsame Zeit",
  peerWaitNoOverlapLate: "Keine gemeinsame Zeit, Zeit wird knapp",
...
const plTranslations: TranslationTable = {
  ...
  peerWaitT1Sent: "Poszło do {name}",
  peerWaitT2Waiting: "Czekamy na {name}",
  peerWaitT3Quiet: "Od {name} na razie cisza",
  peerWaitT4Nudged: "Przypomniałem {name}",
  peerWaitT5Deadline: "Czekamy na {name}, czas ucieka",
  peerWaitAnon: "Czekamy na drugą stronę",
  peerWaitNoOverlap: "Nie ma jeszcze wspólnego terminu",
  peerWaitNoOverlapLate: "Wciąż brak wspólnego terminu, czas ucieka",
